...
public class StatusDetailView extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        funciona = (CheckBox) findViewById(R.id.cbNoError);
        errores = (CheckBox) findViewById (R.id.cbError);
        error1CB = (CheckBox) findViewById(R.id.cbErrorPhysicalDamage);
        error2CB = (CheckBox) findViewById(R.id.cbLowBattery);
        error3CB = (CheckBox) findViewById(R.id.cbLowLiquid);
        sol1CB = (CheckBox) findViewById(R.id.cbPhysicalRepair);
        sol2CB = (CheckBox) findViewById(R.id.solucion2CB);
        sol3CB = (CheckBox) findViewById(R.id.cbChangeLiquid);
